...
extern NSString * _Nullable const WMGTextStrikethroughStyleAttributeName;
extern NSString * _Nullable const WMGTextStrikethroughColorAttributeName;
extern NSString * _Nullable const WMGTextDefaultForegroundColorAttributeName;
